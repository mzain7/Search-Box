...
function SearchBar
    ({ value, onChange, onKeyDown, ref, error }) {
    ...
    return (
        <div className="relative mb-4">
            ...
            <input
                ...
                className={`w-full py-3 pl-10 pr-4 bg-gray rounded-lg text-black placeholder-paragraph focus:outline-none focus:ring-2 ${error ? "ring-2 ring-error" : "focus:ring-primary"
                    }`}
